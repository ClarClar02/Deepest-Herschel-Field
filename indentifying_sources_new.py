...
def find_source (ra_catalogue, dec_catalogue):
    ...
    return index, redshift, catalogue['irac1flux'][index], catalogue['irac1fluxerr'][index], catalogue['irac2flux'][index], catalogue['irac2fluxerr'][index], catalogue['irac3flux'][index], catalogue['irac3fluxerr'][index], catalogue['irac4flux'][index], catalogue['irac4fluxerr'][index], catalogue['mips24flux'][index], catalogue['mips24fluxerr'][index]
...
# Create dataframe
df = source_id.to_frame(name=r'# id')
...
df['MIPS21'] = float(MIPS24_flux_XID)
df['MIPS21_err'] = float(MIPS24_flux_err_XID)


# Convert to txt
df.to_csv(r'input.txt', sep=' ')
